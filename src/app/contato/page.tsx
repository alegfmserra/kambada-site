...
import { REDES, linkWhatsApp } from "@/lib/site";

/**
 * Contato. Só canais confirmados: o WhatsApp extraído dos links do site atual
 * e as redes sociais divulgadas nele. O número não aparece escrito em lugar
 * nenhum — quem clica cai direto na conversa.
 */
    ...
    <section>
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-24">
        <h1 className="font-display text-4xl leading-tight font-extrabold text-balance sm:text-5xl">
          Se achega, <span className="destaque">vem falar</span> com a gente
        </h1>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          <a
            ...
            className="group rounded-2xl bg-kambada-amarelo p-8 text-kambada-grafite transition-colors hover:bg-kambada-amarelo-escuro"
          >
            <svg
              width="34"
              height="34"
            ...
            <p className="mt-3 leading-relaxed text-kambada-grafite/80">
              O caminho mais rápido. Toque aqui e a conversa abre direto — sem
              precisar salvar número nenhum.
            </p>
            <p className="mt-5 font-display font-semibold underline underline-offset-4">
              Abrir conversa →
            </p>
          </a>

          <div className="rounded-2xl border border-borda bg-superficie p-8">
            <h2 className="font-display text-2xl font-bold">Nossas redes</h2>
            <p className="mt-3 leading-relaxed text-texto-suave">
              É por lá que a gente mostra o que sai da oficina.
            </p>
              ...
              {REDES.map((rede) => (
                <li key={rede.nome}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-lg text-texto-suave transition-colors hover:text-kambada-amarelo-escuro"
                  >
                    {rede.nome} →
                  </a>
                </li>
